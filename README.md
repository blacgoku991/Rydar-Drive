...
- **Suivi des vols** : une course au départ d'un aéroport avec numéro de vol suit l'arrivée réelle. Si le vol a 35 min de retard, la prise en charge est décalée de 35 min, et le chauffeur comme la centrale sont prévenus. Un vol à l'heure ne change jamais l'heure choisie par le client. Fournisseurs AeroDataBox, Aviationstack ou FlightAware, avec un simulateur sans clé.
- **Alertes de suivi, la centrale décide** : chauffeur en retard sur l'heure promise, immobile, GPS muet, course planifiée pas démarrée. Le rattacheur reçoit l'alerte avec un son et choisit : **Garder**, **Réattribuer** à un chauffeur précis ou **Relancer** la recherche. Rien n'est retiré automatiquement.
- **Messagerie** : fil direct centrale ⇄ chauffeur et fil de **toute la flotte**. Les chauffeurs y **signalent en un geste** police, contrôle, accident, bouchon ou danger, position à l'appui. Ces signalements apparaissent sur toutes les cartes, expirent seuls et se confirment ou s'infirment d'un tap.
- **Gains et documents du chauffeur** : chiffre du jour, de la semaine et du mois avec histogramme (net estimé si une commission est réglée). Carte VTC, permis, assurance… sont déposés depuis l'app puis validés par la centrale, avec rappels à J-30, J-7 et à l'échéance.
